...
Android 기기 내에서 PDF/HWPX 문서를 열람하고 다양한 형식으로 변환 및 내보내기를 수행할 수 있는 네이티브 문서 뷰어 및 유틸리티 애플리케이션입니다. 외부 서버와의 통신 없이 모든 변환 로직이 기기 내부(Local-only)에서 처리되도록 설계되었습니다.
